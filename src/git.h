...
enum ConsoleType {
	CONSOLE_REGULAR_NES = 0x00,
	CONSOLE_VS = 0x01,
	CONSOLE_PC10 = 0x02,
	CONSOLE_FAMICLONE_DECIMAL_MODE = 0x03,
	CONSOLE_EPSM = 0x04,
	CONSOLE_VT01STN = 0x05,
	CONSOLE_VT02 = 0x06,
	CONSOLE_VT03 = 0x07,
	CONSOLE_VT09 = 0x08,
	CONSOLE_VT32 = 0x09,
	CONSOLE_VT369 = 0x0A,
	CONSOLE_UM6578 = 0x0B,
	CONSOLE_FAMICOM_NETWORK_SYSTEM = 0x0C
};
...
enum VSTYPES {
	VS_TYPE_NORMAL     = 0, /* VS-UniSystem (Normal) */
	...
	VS_TYPE_DUAL       = 5, /* VS-DualSystem (Normal) */
	VS_TYPE_RAID       = 6  /* VS-DualSystem (Raid on Bungeling Bay protection) */
};
