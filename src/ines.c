...
/*    INES_BOARD( "",                         20, Mapper20_Init ) */
	...
	INES_BOARD( "EL870914C/HUMMER/JY BOARD", 35, Mapper209_Init         )
...
/*    INES_BOARD( "",                            84, Mapper84_Init ) */
	...
	INES_BOARD( "HUMMER/JY BOARD",           90, Mapper209_Init         )
...
int iNESLoad(const char *name, FCEUFILE *fp) {
	...
	if (GameInfo->type == GIT_VSUNI) {
		...
		case 0x5: vsuni_system.type = VS_TYPE_DUAL; break;
		case 0x6: vsuni_system.type = VS_TYPE_RAID; break;
		}
